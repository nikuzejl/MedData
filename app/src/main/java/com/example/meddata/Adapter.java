...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.main_customized,parent,false);
    ...
    public void retrieveVisit (View view){
        Intent intent = new Intent(view.getContext(), Retrieve_Visit.class);
